...
import static com.share.bag.APP.context;
...
//                Log.e("OKhttpUtils","这是我的:"+call);
    ...
    @Override
    public <T> void postList(String url, Map<String, String> params, final MyNetWorkCallback<String> callback) {
        FormBody.Builder builder = new FormBody.Builder();
        if (params != null && params.size() > 0) {
            Set<String> keys = params.keySet();
            for (String key : keys) {
...
//
//    @Override
//    public <T> void postList(String url, Map<String, String> params, final MyNetWorkCallback<T> callback) {
//
//        FormBody.Builder builder = new FormBody.Builder();
//        if(params !=null && params.size() > 0){
//            Set<String> keys = params.keySet();
...
//                            Gson gson = new Gson();
//
////                            Log.e("ttttt",gson.fromJson(jsonData, type));
////                            callback.onSuccess();
////                        } catch (JSONException e) {
////                            e.printStackTrace();
////                        }
...
//     * @param callBack
//     * @param <T>
//     * @return 这是睡写的    不知道，我没事从来不进来这类
//     */
//    private <T> T getGeneric(String jsonData,MyNetWorkCallback<T> callBack){
//        Gson gson = new Gson();
//        //通过反射获取泛型的实例  zhe shi sha
//        Type[] types = callBack.getClass().getGenericInterfaces();
//        Type[] actualTypeArguments = ((ParameterizedType) types[0]).getActualTypeArguments();
//        Type type = actualTypeArguments[0];
//        T t = gson.fromJson(jsonData,type);
...
//    }
//
//    private <T> T getListGeneric(String jsonData, MyNetWorkCallback<T> callback){
//
//        Type type = new TypeToken<List<T>>(){}.getType();
//        Gson gson = new Gson();
